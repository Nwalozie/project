...
import { BudgetSettings } from '../Currency/BudgetSettings';
    ...
    <div className='Overview-container'>
          ...
          <div className="Balance-container__totalBalance">
            <div className='totalBalance'>
              <div className='totalBalance-content'>
                ...
                <h2>Total Balance</h2>
                <div className='totalBalance-amount'>{currency} 2100</div>
              </div>
      ...
      <div className='Overview-content-2'>
        ...
        <div className="budget-overview">
          ...
          <div>
            <span>{convertCurrency(expenseAmount, 'USD', currency)} {currency}</span>
          </div>
          <div>
            <BudgetSettings/>
          </div>
